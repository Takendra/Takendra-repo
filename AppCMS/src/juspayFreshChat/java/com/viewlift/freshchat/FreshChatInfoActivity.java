...
public class FreshChatInfoActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (setEditTextPhone(editTextPhone.getText().toString())
                    ...
                    FreshChatSDKUtil.launchFreshChat(appCMSPresenter.getCurrentActivity(),
                            appPreference.getFreshchatEmail(),
    ...
    public boolean setEditTextEmail(String editTextEmail) {
        if (editTextEmail == null || TextUtils.isEmpty(editTextEmail)  || !Utils.isEmailValid(editTextEmail)) {
            if (appCMSPresenter.getLocalisedStrings() != null)
                textViewEmailError.setText(appCMSPresenter.getLocalisedStrings().getEmailFormatValidationMsg());
            textViewEmailError.setVisibility(View.VISIBLE);
        } else {
            appPreference.setFreshchatEmail(editTextEmail);
            return true;
        }
        return false;
    }
