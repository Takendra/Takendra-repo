...
public final class LocalPlayback implements Playback {
    ...
    public void play(MediaMetadataCompat item, long currentPosition) {
        ...
        if (mediaHasChanged || mExoPlayer == null || (currentPosition > 0 && (AudioPlaylistHelper.getInstance().isLastStatePause())) || (appPreference.getAudioReload())) {

            appPreference.setAudioReload(false);
        ...
        mCallback.onPlaybackStatusChanged(getState());
        if (appCMSPresenter != null && appPreference.getAudioReload()) {
            relaodAudioItem();
        }
    ...
    private final class ExoPlayerEventListener implements Player.EventListener {
            ...
            switch (playbackState) {
                ...
                case ExoPlayer.STATE_BUFFERING:
                    if (mCallback != null) {
                        ...
                        if (beaconBuffer != null && appCMSPresenter.getAppCMSMain().getFeatures() != null && appCMSPresenter.getAppCMSMain().getFeatures().isEnableQOS()) {
                ...
                case ExoPlayer.STATE_READY:
                    if (mCallback != null) {
                        ...
                        if (beaconPing != null) {
                            ...
                            if (!sentBeaconFirstFrame && appCMSPresenter != null && appCMSPresenter.getAppCMSMain().getFeatures().isEnableQOS()) {
        ...
        public void onPlayerError(ExoPlaybackException error) {
            ...
            appPreference.setAudioReload(true);
            relaodAudioItem();
