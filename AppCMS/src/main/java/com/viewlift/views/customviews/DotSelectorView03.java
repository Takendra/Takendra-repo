...
public class DotSelectorView03 extends BaseView implements OnInternalEvent {
    ...
    public DotSelectorView03(Context context,
                             Component component,
                             int selectedColor,
                             int deselectedColor) {
        super(context);
    ...
    private ImageView createDotImageView(Context context) {
        ...
        dotImageView.setBackgroundResource(R.drawable.caraousel_03_indicator);
        ((GradientDrawable) dotImageView.getBackground()).setColor(deselectedColor);


        /*int imageWidth = (int) getViewWidth(context,
                component.getLayout(),
                (int) context.getResources().getDimension(R.dimen.dot_selector_03_width));
        int imageHeight = (int) getViewHeight(context,
                component.getLayout(),
                (int) context.getResources().getDimension(R.dimen.dot_selector_03_height));
        */
        int imageWidth = (int) getResources().getDimension(R.dimen.dot_selector_03_width);
        int imageHeight = (int) getResources().getDimension(R.dimen.dot_selector_03_height);
...
/*        int viewWidth = (int) getViewWidth(context,
                component.getLayout(),
                (int) context.getResources().getDimension(R.dimen.dot_selector_03_item_width));
        int viewHeight = (int) getViewHeight(context,
                component.getLayout(),
                (int) context.getResources().getDimension(R.dimen.dot_selector_03_item_height));*/
        int viewWidth = (int) getResources().getDimension(R.dimen.dot_selector_03_item_width);
        int viewHeight = (int) getResources().getDimension(R.dimen.dot_selector_03_item_height);
