...
public class ArticleFeedModule extends LinearLayout {
    ...
    public void init() {
                    ...
                    case PAGE_LABEL_KEY:
                        switch (componentKey) {
                            case PAGE_ARTICLE_FEED_BOTTOM_TEXT_KEY:
                                ...
                                ViewCreator.setTypeFace(context,appCMSPresenter, jsonValueKeyMap, childComponent, publisherName);
                                ...
                                ViewCreator.  setTypeFace(context,appCMSPresenter, jsonValueKeyMap, childComponent, publishDate);
                            ...
                            case PAGE_THUMBNAIL_TITLE_KEY:
                                ...
                                ViewCreator. setTypeFace(context,appCMSPresenter, jsonValueKeyMap, childComponent, titleText);
                            ...
                            case PAGE_THUMBNAIL_DESCRIPTION_KEY:
                                ...
                                ViewCreator. setTypeFace(context, appCMSPresenter,jsonValueKeyMap, childComponent, subTitleText);
                                break;
                            case PAGE_API_SUMMARY_TEXT_KEY:
                                ...
                                ViewCreator.  setTypeFace(context,appCMSPresenter, jsonValueKeyMap, childComponent, summeryText);
                                break;
                            case PAGE_THUMBNAIL_READ_MORE_KEY:
                                ...
                                readMore.setText(appCMSPresenter.getLanguageResourcesFile().getUIresource(childComponent.getText()));
                                readMore.setTextSize(fontSize);
                                readMore.setTextColor(textColor);
                                readMore.setMaxLines(childComponent.getNumberOfLines());
                                ViewCreator.  setTypeFace(context,appCMSPresenter, jsonValueKeyMap, childComponent, readMore);
                                break;
                        }
        ...
        publisherName.setGravity(Gravity.END);
        publishDate.setGravity(Gravity.END);
        publishInfo.setGravity(Gravity.CENTER_VERTICAL);



        readMore.setGravity(Gravity.START);
                            ...
                            case PAGE_ARTICLE_FEED_BOTTOM_TEXT_KEY:
                                if (data != null && data.getContentDetails() != null &&
                                    ...
                                    if (data.getGist() != null && appCMSPresenter != null &&
                                        ...
                                        long publishDateMillseconds = 0;
                                        try {
                                             publishDateMillseconds = Long.parseLong(data.getGist().getPublishDate());
                                        }catch (Exception e){
                                            publishDateMillseconds = CommonUtils.getMillisecondFromDateString("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", data.getGist().getPublishDate());
                                        }
                                    ...
                                    if (data.getContentDetails().getAuthor().getName() != null) {
                                        publisherName.setText(data.getContentDetails().getAuthor().getName());
