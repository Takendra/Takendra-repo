...
public class AppCMSSimpleExoPlayerView {}/*extends FrameLayout {
    ...
    private final FrameLayout  adsOverlay;
    ...
    public AppCMSSimpleExoPlayerView(Context context) {
        this(context, null);
    }

    public AppCMSSimpleExoPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AppCMSSimpleExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //contentFrame = (FrameLayout) findViewById(com.google.android.exoplayer2.ui.R.id.exo_content_frame);
        ...
        adsOverlay = (FrameLayout) findViewById(com.google.android.exoplayer2.ui.R.id.exo_ad_overlay);
        ...
        CustomPlaybackControlView customController = (CustomPlaybackControlView) findViewById(R.id.custom_exo_controller);
    ...
    *//**
    ...
    public CustomPlaybackControlView getController()
    {
    ...
    *//**
     ...
     *
     * @param controlDispatcher The {@link CustomPlaybackControlView.ControlDispatcher}, or null to use
    ...
    *//**
    ...
    public FrameLayout getAdsOverlay(){
        return adsOverlay;
    }
    *//**
