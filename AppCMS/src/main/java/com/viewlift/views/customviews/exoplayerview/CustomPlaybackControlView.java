...
public class CustomPlaybackControlView extends FrameLayout {
    ...
    public CustomPlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr, AttributeSet playbackAttrs) {
        ...
        if (playbackAttrs != null) {
            ...
            try {
                ...
                fastForwardMs = a.getInt(com.google.android.exoplayer2.ui.R.styleable.PlayerControlView_fastforward_increment,
                        fastForwardMs);
                showTimeoutMs = a.getInt(com.google.android.exoplayer2.ui.R.styleable.PlayerControlView_show_timeout, showTimeoutMs);
                controllerLayoutId = a.getResourceId(com.google.android.exoplayer2.ui.R.styleable.PlayerControlView_controller_layout_id,
                        controllerLayoutId);
        ...
        progressController = findViewById(R.id.seek_bar_parent);
    ...
    private void updateNavigation() {
        ...
        setViewVisibility(isPlayingLive, findViewById(com.google.android.exoplayer2.ui.R.id.exo_progress));
        setViewVisibility(isPlayingLive, durationView);
        setViewVisibility(isPlayingLive, positionView);
    ...
    private void setViewVisibility(boolean visibility, View view) {
        view.setVisibility(visibility ? INVISIBLE : VISIBLE);
    }
