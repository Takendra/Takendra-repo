package com.viewlift.views.customviews.otpView;
...
public class OtpView extends AppCompatEditText {
  ...
  private void init() {
    ...
    otpViewItemCount   = DEFAULT_COUNT;
    otpViewItemHeight  = (int) (48 * scale + 0.5f);
    otpViewItemWidth   = (int) (48 * scale + 0.5f);
    otpViewItemSpacing = (int) (10 * scale + 0.5f);
    lineWidth          = (int) (2 * scale + 0.5f);
    isCursorVisible    = true;
    cursorColor        = getCurrentTextColor();
    cursorWidth        = (int) (2 * scale + 0.5f);
    hideLineWhenFilled = false;
  ...
  public boolean onKeyPreIme(int keyCode, KeyEvent event) {
    if (event.getAction() == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_BACK && getContext() != null && Utils.isFireTVDevice(getContext())) {
      try {
