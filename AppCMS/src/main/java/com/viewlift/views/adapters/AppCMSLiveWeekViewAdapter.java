...
public class AppCMSLiveWeekViewAdapter extends RecyclerView.Adapter<AppCMSViewAdapter.ViewHolder>
    ...
    public AppCMSLiveWeekViewAdapter(Context context,
    ...
    public void onBindViewHolder(@NonNull AppCMSViewAdapter.ViewHolder holder, int position) {
        if (holder.componentView != null) {
            ...
            bindView(holder.constraintComponentView, null, position);
        }
    }
