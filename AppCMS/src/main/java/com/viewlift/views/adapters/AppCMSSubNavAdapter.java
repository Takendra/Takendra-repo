...
public class AppCMSSubNavAdapter extends RecyclerView.Adapter<AppCMSSubNavAdapter.ViewHolder>
    ...
    public AppCMSSubNavAdapter(Context context,
            ...
            onClickHandler = new CollectionGridItemView.OnClickHandler() {
                ...
                public void click(CollectionGridItemView collectionGridItemView,
                    ...
                    if (isClickable) {
                        ...
                        if(viewTypeKey==AppCMSUIKeyType.PAGE_SUB_NAV_MODULE_KEY){

                            if(!appCMSPresenter.navigateToPage(data.getGist().getId(),
