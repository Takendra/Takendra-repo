...
public class AppCMSBrowseCategoryAdapter extends RecyclerView.Adapter<AppCMSBrowseCategoryAdapter.ViewHolder>
    ...
    public AppCMSBrowseCategoryAdapter(Context context,
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (uiBlockName == AppCMSUIKeyType.UI_BLOCK_FILTER_02) {
            ...
            if (background != null) {
                if (appCMSPresenter.getBrowseCategorySelection() != null && Integer.parseInt(appCMSPresenter.getBrowseCategorySelection()) == position) {
            ...
            if (uiBlockName == AppCMSUIKeyType.UI_BLOCK_FILTER_02) {
                onClickHandler = new CollectionGridItemView.OnClickHandler() {
                    ...
                    public void click(CollectionGridItemView collectionGridItemView,
                        ...
                        if (jsonValueKeyMap.get(component.getKey()) == AppCMSUIKeyType.PAGE_BROWSE_TOP_GRID_KEY) {
                            appCMSPresenter.setBrowseCategorySelection(clickPosition + "");
                            appCMSPresenter.setBrowseCategorySelected(data.getGist().getTitle());
                            appCMSPresenter.navigateToBrowsePage(data.getGist().getTitle(),null);
                            SeasonTabSelectorBus.instanceOf().setClearFilter(true);
                            return;
                        }
                    }
