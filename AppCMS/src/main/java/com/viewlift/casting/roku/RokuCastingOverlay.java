...
public class RokuCastingOverlay extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        castingCoverImage = findViewById(R.id.castingCoverImage);
        backViewInRokuTime = findViewById(R.id.backViewInRokuTime);
        backViewInRokuTime.setOnClickListener(new View.OnClickListener() {
            @Override
