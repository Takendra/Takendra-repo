...
public class CastDisconnectDialog extends MediaRouteControllerDialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleView = findViewById(androidx.mediarouter.R.id.mr_control_title);

        mRouteNameTextView = findViewById(androidx.mediarouter.R.id.mr_name);

        mDisconnectButton = findViewById(BUTTON_DISCONNECT_RES_ID);
        mDisconnectButton.setText(androidx.mediarouter.R.string.mr_controller_disconnect);
        ...
        if (toBeDisconnectDevice != null) {
            if (selectedDeviceType.equals(CHROMECAST)) {
                ...
                findViewById(androidx.mediarouter.R.id.mr_custom_control).setVisibility(View.GONE);
                findViewById(androidx.mediarouter.R.id.mr_default_control).setVisibility(View.GONE);
