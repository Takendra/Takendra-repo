...
public class AppCMSGoogleLoginCall {
    ...
    public void call(String url,
                     String googleAccessToken,String xApi,String authToken,
        ...
        appCMSGoogleLoginRest.login(url, authTokenMap,new GoogleLoginRequest(googleAccessToken)).enqueue(new Callback<GoogleLoginResponse>() {
            @Override
