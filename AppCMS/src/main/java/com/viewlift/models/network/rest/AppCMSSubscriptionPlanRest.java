...
public interface AppCMSSubscriptionPlanRest {
    ...
    @GET
    Call<List<ContentDatum>> getPlansById(@Url String url, @HeaderMap Map<String, String> authHeaders);
    ...
    @POST
    Call<AppCMSSubscriptionPlanResult> validate(@Url String url, @HeaderMap Map<String, String> authHeaders, @Body SubscriptionRequest request);
}
