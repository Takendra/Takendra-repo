...
public class Layout implements Serializable {
    ...
    public void setConstraintMarginTop(int marginTop){
        getMobile().setConstraint_MarginTop(marginTop);
        getTabletPortrait().setConstraint_MarginTop(marginTop);
        getTabletLandscape().setConstraint_MarginTop(marginTop);
    }
}
