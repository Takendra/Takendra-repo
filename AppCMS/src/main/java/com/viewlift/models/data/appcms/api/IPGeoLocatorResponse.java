...
public class IPGeoLocatorResponse {
    ...
    {
        return "ClassPojo [postalcode = "+postalcode+", metrocode = "+metrocode+", subdivision_iso_code = "+subdivision_iso_code+", origip = "+origip+", subdivision_en_name = "+subdivision_en_name+", countryisocode = "+countryisocode+", ispname = "+ispname+", timezone = "+timezone+", isporganization = "+isporganization+", continent = "+continent+", countryname = "+countryname+", longitude = "+longitude+", latitude = "+latitude+", cityname = "+cityname+"]";
    }
}
