...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public static void setDownloadTitle(String downloadTitle) {
    TrackSelectionDialog.downloadTitle = downloadTitle;
  }
  ...
  public View onCreateView(
    ...
    View dialogView = inflater.inflate(R.layout.track_selection_dialog, container, true);
    TabLayout tabLayout = dialogView.findViewById(R.id.track_selection_dialog_tab_layout);
    ViewPager viewPager = dialogView.findViewById(R.id.track_selection_dialog_view_pager);
    AppCompatButton cancelButton = dialogView.findViewById(R.id.track_selection_dialog_cancel_button);
    AppCompatButton okButton = dialogView.findViewById(R.id.track_selection_dialog_ok_button);
    if(okButton!=null && appCMSPresenter!=null) {
      okButton.setBackgroundColor(appCMSPresenter.getBrandPrimaryCtaColor());
    }
    ((AppCompatTextView)dialogView.findViewById(R.id.downloadTextId)).setText(downloadTitle);
    ((AppCMSApplication) getContext().getApplicationContext()).getAppCMSPresenterComponent().inject(this);
    ViewCreator.setTypeFace(getContext(), appCMSPresenter, appCMSPresenter.getJsonValueKeyMap(), new Component(), okButton);
    ViewCreator.setTypeFace(getContext(), appCMSPresenter, appCMSPresenter.getJsonValueKeyMap(), new Component(), cancelButton);
  ...
  public void show(FragmentManager manager, String tag) {
    try {
      ...
      try {
        ...
        Log.d("TrackSelectionDialog", "Exception", e);
      }
    }
  }
}
