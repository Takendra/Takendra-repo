                ...
                continueButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (emailId.getEditableText().toString().length() == 0) {
                            String errorMessage = appCMSPresenter.getLocalisedStrings().getEmptyEmailValidationText();
                            String errorHeader = appCMSPresenter.getLanguageResourcesFile().getUIresource(getString(R.string.app_cms_forgot_password_title));
                            appCMSPresenter.openTVErrorDialog(errorMessage,
                                    errorHeader, false);
                            return;
                        }

                        if (!com.viewlift.Utils.isEmailValid(emailId.getEditableText().toString())) {
                        ...
                        appCMSPresenter.resetPassword(emailId.getEditableText().toString(), new Action0() {
                            @Override
                            public void call() {
                                dismiss();
                            }
