    ...
    private boolean isVideoDetailPage () {
        ...
        if (appCMSPageUI != null
            ...
            for (ModuleList moduleList : appCMSPageUI.getModuleList()) {
                ...
                || (moduleList.getType().toLowerCase().contains("ShowDetail".toLowerCase()) && !(moduleList.getType().toLowerCase().contains("AC ShowDetail 06".toLowerCase())))
                || moduleList.getType().toLowerCase().contains("BundleDetail".toLowerCase()) || moduleList.getType().toLowerCase().contains("AC SelectPlan 06".toLowerCase()))) {
