...
public class CustomHeaderItem extends HeaderItem {
    ...
    private int mListRowTopMargin = -1;
    ...
    public int getmListRowTopMargin() {
        return mListRowTopMargin;
    }

    public void setmListRowTopMargin(int mListRowTopMargin) {
        this.mListRowTopMargin = mListRowTopMargin;
    }
