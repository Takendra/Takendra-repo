...
public class ShowDetailModuleView06 extends TVModuleView {
    private static final String TAG = ShowDetailModuleView06.class.getSimpleName();
    private final AppCMSPageAPI appCMSPageAPI;

    public ShowDetailModuleView06(Context context,
