...
public class PlayerModuleView extends TVModuleView {
    private static final String TAG = PlayerModuleView.class.getSimpleName();
    private final AppCMSPageAPI appCMSPageAPI;

    public PlayerModuleView(Context context,
