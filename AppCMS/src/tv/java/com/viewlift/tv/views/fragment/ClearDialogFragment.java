...
public class ClearDialogFragment extends AbsDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvDescription.setTypeface(Utils.getSpecificTypeface(getActivity(), appCMSPresenter, getString(R.string.app_cms_page_font_regular_key)));
        ...
        positiveButton.setOnFocusChangeListener((view, b) -> isFocusOnPositiveButton = b);
        negativeButton.setOnFocusChangeListener((view, b) -> isFocusOnPositiveButton = !b);
